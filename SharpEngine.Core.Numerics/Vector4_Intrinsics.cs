...
#pragma warning restore IDE0161 // Convert to file-scoped namespace
{
    ...
    public partial struct Vector4
    {
        ...
        [JitIntrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly void CopyTo(Single[] array, int index)
        {
            if (array == null)
            ...
            if ((array.Length - index) < 4)
                throw new ArgumentException("The number of elements in the source vector is greater than the available space in the destination array.", nameof(index));
        ...
        [JitIntrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float Dot(Vector4 vector1, Vector4 vector2) => vector1.X * vector2.X +
                   vector1.Y * vector2.Y +
                   vector1.Z * vector2.Z +
                   vector1.W * vector2.W;
