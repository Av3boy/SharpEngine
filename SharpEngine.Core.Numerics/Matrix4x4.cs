...
public struct Matrix4x4 : IEquatable<Matrix4x4>
{
    ...
    /// <returns>The rotation matrix.</returns>
    public static Matrix4x4 CreateFromQuaternion(System.Numerics.Quaternion quaternion)
    {
        Matrix4x4 result;
    ...
    {
        System.Numerics.Quaternion q = System.Numerics.Quaternion.CreateFromYawPitchRoll(yaw, pitch, roll);
    ...
    public static Matrix4x4 CreateShadow(Vector3 lightDirection, System.Numerics.Plane plane)
    {
        System.Numerics.Plane p = System.Numerics.Plane.Normalize(plane);
    ...
    public static Matrix4x4 CreateReflection(System.Numerics.Plane value)
    {
        value = System.Numerics.Plane.Normalize(value);
    ...
    public static bool Decompose(Matrix4x4 matrix, out Vector3 scale, out System.Numerics.Quaternion rotation, out Vector3 translation)
    {
        ...
        Vector3[] vectorBasis = new Vector3[]
        {
        ...
        Vector3[] canonicalBasis = new Vector3[]
        {
        ...
        CanonicalBasis canonical = new CanonicalBasis
        {
            Row0 = canonicalBasis[0],
            Row1 = canonicalBasis[1],
            Row2 = canonicalBasis[2]
        };
        ...
        void SetBasisRow(int row, Vector3 value)
        {
            switch (row)
            {
                case 0:
        ...
        SetBasisRow(0, vectorBasis[0]);
        SetBasisRow(1, vectorBasis[1]);
        SetBasisRow(2, vectorBasis[2]);

        float scaleX = vectorBasis[0].Length();
        float scaleY = vectorBasis[1].Length();
        float scaleZ = vectorBasis[2].Length();

        uint a, b, c;
        #region Ranking
        float x = scaleX, y = scaleY, z = scaleZ;
        if (x < y)
        {
            if (y < z)
            {
        ...
        SetBasisRow((int)a, vectorBasis[a]);
        ...
        SetBasisRow((int)b, vectorBasis[b]);
        ...
        SetBasisRow((int)c, vectorBasis[c]);
        ...
        else
        {
            ...
            // TODO: Copy over the code from Quaternion.CreateFromRotationMatrix() to avoid creating a temporary matrix
            // https://github.com/microsoft/referencesource/blob/main/System.Numerics/System/Numerics/Quaternion.cs
            rotation = System.Numerics.Quaternion.CreateFromRotationMatrix((System.Numerics.Matrix4x4)matTemp);
        }
    ...
    public static Matrix4x4 Transform(Matrix4x4 value, System.Numerics.Quaternion rotation)
    {
