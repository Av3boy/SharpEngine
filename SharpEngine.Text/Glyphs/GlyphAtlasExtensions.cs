...
public static class GlyphAtlasExtensions
{
    ...
    /// </summary>
    public static Core.Components.Properties.Textures.Texture BuildRuntimeTexture(this GlyphAtlas atlas, GL gl)
    {
        // Create RGBA buffer
        ...
        var tex = new Core.Components.Properties.Textures.Texture(gl, rgba, atlas.Width, atlas.Height, path: "<glyph-atlas>");
        return tex;
    }
